...
/**
 * Simple host fragment.
 *
 * @author verstsiu on 2018/5/28.
 * @version 2.0
 */
class SimpleHostFragment: AbstractHostFragment() {
  override fun createFragmentTypes() = arrayOf<Class<*>>(
      SimpleFragment::class.java,
      RecyclerFragment::class.java,
      SimplePagerFragment::class.java,
      NestedPagerFragment::class.java,
      RecyclerFragment::class.java
  )
